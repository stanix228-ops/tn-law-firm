...
// Articles Data Store (Devil's Advocate Edition)
const TN_ARTICLES = [
  {
    id: 'interrogation-rules',
    title: 'Вызов на допрос в полицию: 7 правил, которые спасут вас от тюрьмы',
    category: 'Уголовный террор',
    categoryId: 'criminal',
    ...
    image: 'assets/media/advocate_1.jpeg',
    summary: 'Хватит быть наивной жертвой. Следователю не нужна правда — ему нужна ваша подпись и премия за раскрываемость. Как разбить психологическое давление с первых секунд.',
    content: `
      ...
      <p class="mb-4 text-slate-300">
        Каждую неделю к нам приходят предприниматели и граждане, которые пошли в РУВД «всего на 10 минут просто побеседовать». Они выходят оттуда через ИВС и СИЗО. Если против вас возбуждено дело — вас пришли уничтожить, а не вести философские дискуссии.
      </p>

      <h3 class="font-heading text-xl font-bold text-white mt-8 mb-3 border-l-4 border-red-600 pl-3">1. Повестка, а не «звонок от брата следователя»</h3>
      <p class="mb-4 text-slate-300">
      ...
      <h3 class="font-heading text-xl font-bold text-white mt-8 mb-3 border-l-4 border-red-600 pl-3">3. Никаких «чистосердечных»</h3>
      <p class="mb-4 text-slate-300">
  ...
  },
  {
    ...
    title: 'Отмена решений в Верховном Суде РК: как вырвать победу, когда все суды куплены или проиграны',
    category: 'Верховный Суд РК',
    categoryId: 'supreme',
    author: 'Адвокат Тамара',
    authorRole: 'Управляющий партнер, судебный литигатор ВС РК',
    authorPhoto: 'assets/media/advocate_2.jpeg',
    date: 'Август 2026',
    readTime: '8 мин чтения',
    image: 'assets/media/advocate_2.jpeg',
    summary: 'Реальный разгром оппонентов на 65 000 000 ₸. Как найти критические ошибки судей нижестоящих инстанций и сломать обвинение в столице.',
    content: `
  ...
  },
  {
    ...
    title: 'Защита бизнеса от рейдерства и заказных уголовных дел в Алматы',
    category: 'Война за бизнес',
    categoryId: 'business',
    author: 'Адвокат Нурлан',
    authorRole: 'Партнер по защите бизнеса конторы «T&N»',
    authorPhoto: 'assets/media/advocate_3.jpeg',
    date: 'Июль 2026',
    readTime: '7 мин чтения',
    image: 'assets/media/advocate_3.jpeg',
    summary: 'Как действовать при маскировке коммерческого спора под мошенничество (ст. 190 УК РК), обысках и выемках серверов.',
    content: `
      <p class="lead font-bold text-lg text-red-400 mb-6">
        «Если конкуренты подключили силовиков — обычные методы не работают. Нужен агрессивный правовой контрудар.»
      </p>
      <p class="mb-4 text-slate-300">
        Классическая схема рейдерства в Казахстане: недобросовестный партнер или конкурент пишет заявление о «хищении», на счета компании накладываются аресты, работа блокируется. Мы вступаем в дело в первые часы, обжалуем незаконные следственные действия через следственного судью (ст. 106 УПК РК) и добиваемся закрытия производства за отсутствием состава преступления.
      </p>
    `
  }
];
